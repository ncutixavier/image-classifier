...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['n_correct_dogs_match'] = 0
    results_stats_dic['n_dogs_img'] = 0
    results_stats_dic['n_correct_notdogs'] = 0
    results_stats_dic['n_notdogs_img'] = 0
    results_stats_dic['n_correct_breed_match'] = 0
    results_stats_dic['n_label_match'] = 0
    ...
    #     Both labels are of dogs: results_dic[key][3] = 1 and results_dic[key][4] = 1
        if results_dic[key][3] == 1 and results_dic[key][4] == 1:
            results_stats_dic['n_correct_dogs_match'] += 1
    ...
    results_stats_dic['pct_correct_breed'] = (results_stats_dic['n_correct_breed_match'] / 
                                      results_stats_dic['n_dogs_img'])*100.0

    

     
    # Calculates % label matches
    results_stats_dic['pct_label_match'] = (results_stats_dic['n_label_match'] / 
...
#     print("Iyi dictionaire",results_stats_dic)
