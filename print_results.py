...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("{:30}: {:2d}".format('Number of Images', results_stats_dic['n_images']))
    print("{:30}: {:2d}".format('Number of Dog Images', results_stats_dic['n_dogs_img']))
    ...
    #          results_stats_dic
    #
    print("{:30}: {:2d}".format('Number of "Not-Dog" Images', results_stats_dic['n_notdogs_img']))
    ...
    if (print_incorrect_dogs and 
        ( (results_stats_dic['n_correct_dogs_match'] + results_stats_dic['n_correct_notdogs'])
        ...
        for key in results_dic:
            ...
            if (results_dic[key][3] == 1 and results_dic[key][4] == 0) or (results_dic[key][3] == 0 and results_dic[key][4] == 1):
                print("{}".format(results_dic[key]))
                

    # IF print_incorrect_breed == True AND there were dogs whose breeds 
    # were incorrectly classified - print out these cases                    
    if (print_incorrect_breed and 
        (results_stats_dic['n_correct_dogs_match'] != results_stats_dic['n_correct_breed_match']) 
       ):
